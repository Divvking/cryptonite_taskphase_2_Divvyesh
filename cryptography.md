...
# Dachshund Attacks
## Problem 
- What if the d is too small? Hint provides an image of a Dachshund??
## Thought Process
- Let's try connecting with the netcat command provided
```console
~$ nc mercury.picoctf.net 30761
Welcome to my RSA challenge!
e: 
n: 
c: 
```
- Searching up Dachshund RSA on google and carefully avoiding the writeups which showed up, I opened the Wikipedia page titled `Wiener Attacks` (Another name for the Dachshund is Wiener)
...
- I decided to use owiener, which is a python3 
- Downloading their script, I opened the python script and entered the values of e,n,c obtained from the netcat command.
```python3
import owiener
